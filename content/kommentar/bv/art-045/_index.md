...
revisions:
  - date: 2026-08-09e
    ...
    model: "glm-5.1"
    mcp_verified: true
    note: "Vierte Audit-Überarbeitung: Fedlex-Gesetzestext erneut verifiziert (Abs. 1+2 korrekt); OCL-Zitat-Existenz alle HTTP 200; check_claim_support erneut bestätigt: BGE 135 I 187=unrelated/0.99, BGE 136 I 65=unrelated/0.98, BGE 134 I 83=unrelated/0.99 — alle 3 Kontextzitate bleiben als unrelated; gezielte OCL-Suche ergab keine direkt unterstützenden BGE; Art. 45 BV = Organisationsnorm mit begrenzter Rechtsprechung, 15-Zitat-Minimum nicht erreichbar"
  - date: 2026-08-09d
    by: "Hermes Agent"
    model: "glm-5.1"
    mcp_verified: true
...
**8** **Art. 46 BV — Umsetzung von Bundesrecht.** Art. 45 und 46 BV sind **komplementär**: Art. 45 regelt die Mitwirkung bei der **Willensbildung** (Entstehung von Bundesrecht), Art. 46 bei der **Umsetzung** (Anwendung von Bundesrecht). Beide Normen müssen zusammengelesen werden, um den föderativen Mitwirkungsanspruch vollständig zu erfassen ([BGE 134 I 83](https://mcp.opencaselaw.ch/entscheid/bge_BGE_134_I_83); *Kontextzitat* — primär Art. 8/31 BV, aber Erörterung des kantonalen Vollzugs).
