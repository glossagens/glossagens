...
revisions:
  ...
  - date: 2026-08-12
    ...
    model: "claude-opus-5"
    mcp_verified: true
    note: "Audit: Tote Pinpoints entfernt, Fehlzuordnungen bereinigt, zwei geprüfte Entscheidblöcke ergänzt (BGE 136 I 229 E. 5.3, BGE 142 II 218 E. 2.4.1). Erstmals revisions-Block; agent_verified von true auf false."
  - date: 2026-06-13
    by: "unbekannt"
    model: "unbekannt"
    mcp_verified: false
...
#### [BGE 150 IV 345](https://mcp.opencaselaw.ch/entscheid/bge_BGE_150_IV_345) ff.
...
#### [BGE 150 I 174](https://mcp.opencaselaw.ch/entscheid/bge_BGE_150_I_174) ff.
...
#### [BGE 150 I 183](https://mcp.opencaselaw.ch/entscheid/bge_BGE_150_I_183) ff.
...
#### [BGE 142 II 218](https://mcp.opencaselaw.ch/entscheid/bge_BGE_142_II_218) ff.
...
#### [BGE 140 V 193](https://mcp.opencaselaw.ch/entscheid/bge_BGE_140_V_193) ff.
...
#### [BGE 137 I 195](https://mcp.opencaselaw.ch/entscheid/bge_BGE_137_I_195) ff.
...
#### [BGE 137 V 210](https://mcp.opencaselaw.ch/entscheid/bge_BGE_137_V_210) ff.
...
#### [BGE 136 I 229](https://mcp.opencaselaw.ch/entscheid/bge_BGE_136_I_229) ff.
...
#### [BGE 134 II 244](https://mcp.opencaselaw.ch/entscheid/bge_BGE_134_II_244) ff.
...
#### [BGE 135 V 465](https://mcp.opencaselaw.ch/entscheid/bge_BGE_135_V_465) ff.
...
#### [BGE 126 I 97](https://mcp.opencaselaw.ch/entscheid/bge_BGE_126_I_97)
...
#### [BGer 1C 198/2025](https://mcp.opencaselaw.ch/entscheid/bger_1C_198_2025)
...
#### [BGer 7B_1305/2025](https://mcp.opencaselaw.ch/entscheid/bger_7B_1305_2025)
...
#### [BGer 9C_550/2025](https://mcp.opencaselaw.ch/entscheid/bger_9C_550_2025)
...
#### BGE 136 I 229 — Antizipierte Beweiswürdigung

- **Thema**: Rechtliches Gehör und Verzicht auf beantragte Beweismittel
- **Kernaussage**: Keine Verletzung des rechtlichen Gehörs liegt vor, wenn ein Gericht auf die Abnahme beantragter Beweismittel verzichtet, weil es aufgrund der bereits abgenommenen Beweise seine Überzeugung gebildet hat und ohne Willkür in vorweggenommener Beweiswürdigung annehmen kann, dass seine Überzeugung durch weitere Beweiserhebungen nicht geändert würde.
- **Bedeutung**: Die massgebliche Formulierung der antizipierten Beweiswürdigung. Sie verknüpft den Gehörsanspruch mit dem Willkürverbot: Zulässig ist der Verzicht nur, wenn die vorweggenommene Würdigung willkürfrei ist.
- **OCL**: [BGE 136 I 229, E. 5.3](https://mcp.opencaselaw.ch/entscheid/bge_BGE_136_I_229#e-5-3)

---

#### BGE 142 II 218 — Fristansetzung zur Stellungnahme

- **Thema**: Rechtliches Gehör; Bemessung der Frist zur schriftlichen Stellungnahme
- **Kernaussage**: Die von der Behörde anzusetzende Frist muss so bemessen sein, dass die konkrete Ausübung des rechtlichen Gehörs ohne Schwierigkeiten möglich ist; wird eine Person zur schriftlichen Stellungnahme aufgefordert, muss die Frist ausreichen, um eine begründete Stellungnahme zu verfassen.
- **Bedeutung**: Gibt dem Äusserungsrecht eine praktisch prüfbare zeitliche Dimension — eine zu kurze Frist verletzt den Gehörsanspruch, auch wenn formell Gelegenheit gegeben wurde.
- **OCL**: [BGE 142 II 218, E. 2.4.1](https://mcp.opencaselaw.ch/entscheid/bge_BGE_142_II_218#e-2-4-1)
...
Ausgangslage nach der Link-Umstellung: 48 beurteilte Paare, davon 15 gestützt — 47 %, Urteil C.

### Verborgene Belege und verborgene Fabrikation

25 Links in `_index.md` zeigten auf `www.bger.ch` (Eurospider-Format). Solche Links entziehen den Beleg der Prüfung: Die Fundstelle steht im Linktext, und Text innerhalb eines Markdown-Links wird vom Parser ausgenommen. Vor der Umstellung meldete der Lauf 26 Paare und **null** erfundene Referenzen, danach 49 Paare.

Hinter zwei dieser Links standen Referenzen, die **nicht existieren**:

| zitiert | nächstliegender existierender Entscheid |
|---|---|
| BGE 140 I 195 | BGE 140 I 176 |
| BGE 142 I 81 | BGE 142 I 76 |

Beide sind entfernt. Der Befund ist der Grund, weshalb ein `halluziniert=0` bei einer Datei mit bger.ch-Links nichts besagt.

### Tote Pinpoints

Neun Pinpoints zeigten ins Leere und wurden entfernt (die Zitate bleiben):

BGE 150 IV 345 E. 3 · BGE 150 I 174 E. 5 · BGE 150 I 183 E. 4 · BGE 142 II 218 E. 5 · BGE 140 V 193 E. 4 · BGE 137 I 195 E. 2 · BGE 136 I 229 E. 2 · BGE 134 II 244 E. 3 · BGE 135 V 465 E. 4

Bemerkenswert: Bei sechs davon existiert der **ganze Abschnitt** nicht — BGE 150 IV 345 etwa hat überhaupt nur eine Erwägung 2. Das ist kein Abschnitts-/Erwägungsproblem wie bei Art. 13 und Art. 16 BV, sondern ein frei gewählter Pinpoint.

### Entfernte Belege

Siebzehn Aussagen trugen einen Beleg, der sie nicht stützt. Die Aussagen sind überwiegend zutreffendes Verfahrensrecht; sie bleiben im Text, jetzt ohne Fundstelle:

| Aussage | zugeschriebener Beleg |
|---|---|
| Rechtsverweigerung bei Ablehnung oder unerträglicher Verzögerung | BGE 126 I 97 |
| Beweislast bei fehlendem Zustellungsnachweis | BGer 6B_935/2025, BGE 144 IV 57 |
| Waffengleichheit | BGE 150 I 174 |
| Äusserungsrecht vor dem Entscheid | BGE 137 I 195 |
| Materielles Verständnis des Äusserungsrechts | BGE 136 I 229 |
| Überraschungsverbot | BGE 150 I 174 |
| Konfrontationsanspruch nach Art. 147 StPO | BGE 150 IV 345 |
| Begründungspflicht und Zugang zum Beschwerdeweg | BGE 136 I 229 |
| Konventionsfreundliche Auslegung | BGE 134 I 140 |
| Verhältnis zum Willkürverbot | BGE 126 I 97 |
| Bedingte Entlassung aus der Verwahrung | BGer 7B_1305/2025 |
| Faire Behandlung im Gesellschaftsrecht | BGer 4A_312/2025 |
| Prüfungsergebnis-Anfechtung | BGE 136 I 229 |

### Ergänzt

Zwei Entscheidblöcke mit verifizierter Kernaussage: BGE 136 I 229 E. 5.3 (antizipierte Beweiswürdigung) und BGE 142 II 218 E. 2.4.1 (Bemessung der Frist zur Stellungnahme).
