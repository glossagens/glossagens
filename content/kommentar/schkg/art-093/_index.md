...
revisions:
  ...
  - date: 2026-09-01
    ...
    mcp_verified: true
    note: "Neuerstellung des Praxiskommentars zu Art. 93 SchKG unter Einschluss von Abs. 4 (in Kraft seit 1. Juli 2024); Einarbeitung von BGer 5A_131/2026 sowie BGE 128 III 159 und BGE 113 III 10."
---

## Gesetzeswortlaut

> **Art. 93 SchKG (SR 281.1)** — Beschränkt pfändbare Vermögenswerte
>
...
3. **Fortlaufende Anpassung (Abs. 3)**: Ändern sich Einkommen oder Bedarf, passt das Betreibungsamt die Quote von Amtes wegen an.
4. **Schutz der Krankenversicherung (Abs. 4)**: Seit 1. Juli 2024 kann der Schuldner verlangen, dass die OKP-Prämien direkt vom Arbeitgeber über das Betreibungsamt an die Krankenkasse überwiesen werden.

---

## Kommentierung

### I. Erfasste Einkünfte (Abs. 1)

**Rz. 3** Der Begriff des Erwerbseinkommens ist umfassend zu verstehen. Er umfasst:
- Löhne, Gehälter, Boni und Gratifikationen aus unselbständiger Arbeit;
- Reingewinn und Honorare aus selbständiger Erwerbstätigkeit ([BGE 86 III 15 E. 1](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_005_BGE-86-III-15_1960-03-09.html));
- Taggelder der Arbeitslosen-, Kranken- und Unfallversicherung;
- Renten und Kapitalleistungen der beruflichen Vorsorge (BVG), soweit sie nicht absolut unpfändbar sind nach Art. 92 SchKG ([BGE 113 III 10 E. 2](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_005_BGE-113-III-10_1987-06-05.html));
...
### II. Berechnung des Notbedarfs (Existenzminimum)

**Rz. 5** Die Festsetzung des Notbedarfs erfolgt anhand der Richtlinien der Konferenz der Betreibungs- und Konkursbeamten der Schweiz (KKB). Der Notbedarf umfasst:

| Position | Massgeblicher Ansatz |
|---|---|
| Grundbetrag (Nahrung, Kleidung, Körperpflege, Haushalt, Freizeit) | Pauschal nach KKB-Richtlinien (Alleinstehende, Alleinerziehende, Paare) |
| Wohnkosten | Tatsächlicher, angemessener Mietzins inkl. Nebenkosten |
| Krankenkassenprämien (OKP) | Prämien der obligatorischen Grundversicherung (KVG/OKP) |
| Berufsauslagen | Arbeitsweg (ÖV-Abo oder notwendiges Auto), auswärtige Verpflegung |
| Unterhaltsbeiträge | Tatsächlich bezahlte Alimente für Kinder oder getrennt lebende Ehegatten |
| Krankenkassenprämien (Kinder) | Prämien für minderjährige Kinder (sofern unterhaltspflichtig) |

**Rz. 6** **Grundsatz der tatsächlich bezahlten Beträge (BGE 121 III 20)**: Bei der Berechnung des Existenzminimums können **nur tatsächlich bezahlte Beträge** berücksichtigt werden — dies gilt auch für Wohnungsmietzinse und Krankenkassenprämien ([BGE 121 III 20](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_005_BGE-121-III-20_1995-03-29.html)). Der Schuldner kann eine Revision der Einkommenspfändung verlangen, sobald er nachweist, dass er einen Mietvertrag bzw. einen Versicherungsvertrag abgeschlossen hat und die vereinbarten Beträge auch tatsächlich bezahlt.

**Rz. 7** **Keine Berücksichtigung von Steuern**: Laufende und aufgelaufene Steuern dürfen im betreibungsrechtlichen Existenzminimum nicht eingerechnet werden ([BGE 140 III 337 E. 4.2–4.4](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_005_BGE-140-III-337_2014.html#consideration_4.2)). Die Berücksichtigung von Steuern im Notbedarf verstösst gegen den Grundsatz, dass der Schuldner dem Gläubiger nicht mehr belassen darf, als für seinen unumgänglichen Lebensbedarf erforderlich ist.

**Rz. 8** **Krankenkassenprämien (BGE 134 III 323)**: Bei der Berechnung des Notbedarfs können **nur die Prämien der obligatorischen Krankenversicherung (KVG/OKP)** berücksichtigt werden, nicht jedoch die Prämien der Kranken-Zusatzversicherung (VVG; [BGE 134 III 323 E. 3](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_005_BGE-134-III-323_2008.html)). Die Zusatzversicherung ist eine freiwillige Leistung, die nicht zum unumgänglichen Lebensbedarf gehört.

---

### III. Dauer der Pfändung und Anschlusspfändung (Abs. 2)

**Rz. 9** Die Lohnpfändung dauert maximal **ein Jahr** ab Vollzug. Verlangen weitere Gläubiger innert der Frist von Art. 110/111 SchKG die Fortsetzung der Betreibung, werden sie in dieselbe Pfändungsgruppe aufgenommen; die einjährige Frist verlängert sich dadurch für die Gruppe **nicht**. Nach Ablauf der Einjahresfrist muss der Gläubiger eine neue Betreibung einleiten.

---

### IV. Fortlaufende Anpassung (Abs. 3)

**Rz. 10** Erhält das Betreibungsamt Kenntnis davon, dass sich die für die Bestimmung des pfändbaren Betrags massgebenden Verhältnisse geändert haben (z.B. Lohnänderung, Heirat, Geburt eines Kindes, Auszug eines Kindes), passt es die Pfändung den neuen Verhältnissen von Amtes wegen an. Der Schuldner ist gegenüber dem Betreibungsamt zur Mitwirkung bei der Feststellung seines Existenzminimums verpflichtet und muss allfällige Beweismittel bereits anlässlich der Pfändung und nicht erst vor Bundesgericht angeben ([BGE 119 III 70 E. 1](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_005_BGE-119-III-70_1993-05-05.html)).

---

### V. Direktüberweisung der Krankenkassenprämien (Abs. 4)

**Rz. 11** Um zu verhindern, dass Schuldner den im Notbedarf belassenen Betrag für die Krankenversicherung zweckentfremden und dadurch Leistungsstopps erleiden, sieht der per 1. Juli 2024 eingeführte Abs. 4 ein Antragsrecht vor: Das Betreibungsamt weist den Arbeitgeber an, die OKP-Prämie direkt an das Amt abzuführen, welches sie unmittelbar an den Versicherer weiterleitet.
- **Voraussetzungen**: Antrag des Schuldners, laufende Einkommenspfändung, Prämien und Kostenbeteiligungen gehören zum Existenzminimum.
- **Wirkung**: Die Direktüberweisung sichert die Prämienzahlung und verhindert einen Leistungsaufschub durch die Krankenkasse (Art. 64a KVG).
- **Umsetzung**: Das Betreibungsamt übernimmt die Zahlung unmittelbar an den Versicherer; der Schuldner muss sich nicht um die Prämienzahlung kümmern.
...
Wendet sich der Schuldner gegen die Höhe der gepfändeten Lohnquote, muss er vor Bundesgericht gemäss Art. 42 Abs. 2 BGG im Detail darlegen, welche Notbedarfspositionen die Aufsichtsbehörde willkürlich oder bundesrechtswidrig festgesetzt hat ([BGer 5A_131/2026](http://relevancy.bger.ch/cgi-bin/JumpCGI?id=11.08.2026_5A_131/2026)). Allgemeine Rügen zum Existenzminimum genügen nicht.

### 2. Unterhaltsberechnung bei Konkubinat
...
- [Art. 92 SchKG — Unpfändbare Vermögenswerte](../art-092/)
- [Art. 19 SchKG — Aufsichtsbeschwerde](../art-019/)
- [Art. 110 SchKG — Teilnahme an der Pfändung](../art-110/)
- [Art. 111 SchKG — Pfändungsanschluss Dritter](../art-111/)
- [Art. 271 Ziff. 5 SchKG — Arrestgrund bei Verlustschein](../art-271/)
- [Art. 12 BV — Recht auf Hilfe in Notlagen](https://www.fedlex.admin.ch/eli/cc/1999/404/de#art_12)
- [Art. 64a KVG — Leistungsaufschub bei Prämienrückständen](https://www.fedlex.admin.ch/eli/cc/1995/1328_1328_1328/de#art_64a)