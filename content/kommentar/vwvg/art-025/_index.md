...
revisions:
  - date: 2026-08-16
    ...
    mcp_verified: true
    note: "Audit (Urteil C 44% -> B 62%): Gesetzestext war an zwei Stellen fehlerhaft -- Abs. 1 ('im Instanzenzug' statt 'in der Sache' zuständige Behörde) und vor allem Abs. 3 vollständig fabriziert (behauptete 'Ausnahme von der Verfügungspflicht' statt der tatsächlichen Vertrauensschutzregel bei bereits erlassener Feststellungsverfügung); korrigiert. Abschnitt III (bisher fälschlich 'Abgrenzungen (Abs. 3)') komplett neu geschrieben. BGE 135 II 60 und BGE 132 V 257 wurden mit dem jeweiligen Gegenteil der tatsächlichen Regeste zitiert -- korrigiert. Ein Belegpaar (BGE 132 V 257 E. 2.5) bleibt trotz naher Wortlautübereinstimmung als 'no' markiert (vermutlich Cache-/Modell-Artefakt); zur Bestätigung vorgelegt statt agent_verified gesetzt."
  - date: 2026-08-02
...
- Das Interesse muss besonders, unmittelbar und aktuell sein ([BGE 114 V 201](https://mcp.opencaselaw.ch/entscheid/bge_BGE_114_V_201#e-2)).

### 3. Subsidiarität der Feststellungsverfügung
Die Feststellungsverfügung ist gegenüber der Leistungs- oder Gestaltungsverfügung **subsidiär**. Kann das Rechtsschutzinteresse durch eine Leistungs- oder Gestaltungsverfügung (oder ein entsprechendes Rechtsmittel) ebenso gut oder besser gewahrt werden, fehlt das schutzwürdige Feststellungsinteresse ([BGE 129 V 289](https://mcp.opencaselaw.ch/entscheid/bge_BGE_129_V_289)).

So ist etwa der Entscheid über die Ablehnung eines Gesuchs um Anschluss als Selbstständigerwerbender an eine Ausgleichskasse rechtsgestaltender, nicht bloss feststellender Natur ([BGE 132 V 257](https://mcp.opencaselaw.ch/entscheid/bge_BGE_132_V_257#e-2-5)).

## III. Vertrauensschutz bei bereits erlassener Feststellungsverfügung (Abs. 3)

Abs. 3 schützt nicht die gesuchstellende Person vor der Ablehnung ihres Feststellungsbegehrens, sondern **jede Partei**, die im berechtigten Vertrauen auf eine bereits ergangene Feststellungsverfügung gehandelt hat: Ändert sich die Rechtslage oder erweist sich die Feststellungsverfügung nachträglich als unrichtig, dürfen der Partei daraus keine Nachteile erwachsen, soweit sie gutgläubig auf den Bestand der Verfügung vertraut und im Vertrauen darauf Dispositionen getroffen hat. Die Bestimmung konkretisiert für die Feststellungsverfügung den allgemeinen, aus Art. 9 BV fliessenden Vertrauensschutzgrundsatz.

## IV. Weitere Abgrenzungen
...
Richtet sich das Begehren nicht auf die Feststellung von Rechtsverhältnissen, sondern auf das Unterlassen, Vornehmen oder Wiederaufnehmen von behördlichen Handlungen (Realakten), findet Art. 25a VwVG als Spezialnorm Anwendung.
