---
title: "Art. 28a IVG — Bemessung des Invaliditätsgrades"
weight: 28
date: 2026-08-31
lastmod: "2026-08-31"
description: "Praxiskommentar zu Art. 28a IVG — Bemessung des Invaliditätsgrades bei Erwerbstätigen (Einkommensvergleich), Nichterwerbstätigen (spezifische Methode) und Teilerwerbstätigen (gemischte Methode) inkl. Tabellenlohnabzüge und EMRK-Konformität."
tags: ["IVG", "Invaliditätsbemessung", "Einkommensvergleich", "Gemischte Methode", "Tabellenlohn", "Invalidenversicherung"]
agent_verified: true
revisions:
  - date: 2026-08-31
    ...
    mcp_verified: true
    note: "Neuerstellung Praxiskommentar zu Art. 28a IVG gemäss Glossagens-Standard; Belege verifiziert auf entscheidsuche.ch; BGE 150 V 410, BGE 144 I 21, BGE 143 I 50, BGer 8C_65/2026 verarbeitet."
---
...
1. **Allgemeine Methode des Einkommensvergleichs (Abs. 1)** für Vollerwerbstätige (Verweis auf [Art. 16 ATSG](https://www.fedlex.admin.ch/eli/cc/2000/235/de#art_16));
...
Für voll erwerbstätige Versicherte verweist Art. 28a Abs. 1 Satz 1 IVG unmittelbar auf [Art. 16 ATSG](https://www.fedlex.admin.ch/eli/cc/2000/235/de#art_16): Der Invaliditätsgrad ergibt sich aus der Gegenüberstellung des hypothetischen Einkommens ohne Gesundheitsschaden (Valideneinkommen) und des trotz Gesundheitsschadens zumutbar erzielbaren Resterwerbseinkommens (Invalideneinkommen).
...
Die durch die IV-Revision 2022 eingeführten Verordnungsbestimmungen ([Art. 26bis IVV](https://www.fedlex.admin.ch/eli/cc/1961/29_29_29/de#art_26_bis)) sollten den richterlichen Ermessensspielraum beim bisherigen leidensbedingten Tabellenlohnabzug (nach [BGE 126 V 75](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_007_BGE-126-V-75_2000.html)) durch Pauschalsätze ersetzen. 

In **[BGE 150 V 410 E. 10.6](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_007_BGE-150-V-410_2024.html)** stellte das Bundesgericht klar:
...
- **[BGE 143 I 50 E. 4](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_001_BGE-143-I-50_2017.html)** & **[BGE 143 I 60 E. 3.3.4](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_001_BGE-143-I-60_2017.html)**: Eine revisionsweise Aufhebung oder Herabsetzung einer Invalidenrente ist diskriminierend und verletzt Art. 14 i.V.m. Art. 8 EMRK, wenn allein familiäre Gründe (wie die Geburt von Kindern) zu einem Statuswechsel von «vollerwerbstätig» zu «teilerwerbstätig» führen.
- **[BGE 144 I 21 E. 4.3–4.7](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_001_BGE-144-I-21_2018.html)**: Auch der Statuswechsel von «nichterwerbstätig» zu «teilerwerbstätig» zufolge abnehmenden Betreuungsaufwands darf nicht zu einer revisionsweisen Rentenaufhebung führen.
- **[BGE 145 V 370 E. 4](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_007_BGE-145-V-370_2019.html)**: Bei der Verordnungsberechnung nach Art. 27bis Abs. 3 IVV ist sowohl das Validen- als auch das Invalideneinkommen auf Basis einer hypothetischen Vollzeittätigkeit zu ermitteln, um die proportionale Erwerbseinbusse korrekt abzubilden.
...
- Die Statusbestimmung erfordert den Beweisgrad der **überwiegenden Wahrscheinlichkeit**. Blosse hypothetische Absichtsbekundungen nach Eintritt des Gesundheitsschadens genügen nicht ([SG_VSG IV 2008/86 vom 23.04.2009](https://entscheidsuche.ch/docs/SG_Gerichte/SG_VSG_001_IV-2008-86_2009-04-23.pdf); [SH_OG 63/2021/52 vom 31.03.2023](https://entscheidsuche.ch/docs/SH_OG/SH_OG_001_63-2021-52_2023-03-31.pdf)).
...
**Kantonale Praxis:**
- Eine nur vorübergehende Reduktion des zuvor langjährig ausgeübten Vollzeitpensums zur vorübergehenden Pflege eines kranken Angehörigen rechtfertigt nicht den Schluss auf eine dauerhafte Pensumsreduktion ([SH_OG 63/2016/35 vom 02.02.2021 E. 4](https://entscheidsuche.ch/docs/SH_OG/SH_OG_001_63-2016-35_2021-02-02.pdf)). Es bleibt bei der Einkommensvergleichsmethode für Vollerwerbstätige.
