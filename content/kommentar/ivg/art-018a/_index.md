---
title: "Art. 18a — Arbeitsversuch"
weight: 18
date: 2026-07-31
lastmod: 2026-07-31
description: "Kommentar zu Art. 18a IVG: Arbeitsversuch der Invalidenversicherung, Taggeldanspruch, sinngemässe Anwendbarkeit von Arbeitsvertragsrecht, fehlender Unterbruch beitragspflichtiger Beschäftigung im GAV-FAR-Betrieb."
tags: ["IVG", "Arbeitsversuch", "Eingliederungsmassnahme", "Taggeld", "Arbeitsvertragsrecht", "GAV FAR", "Sozialversicherungsrecht", "BVG"]
agent_verified: true
revisions:
  - date: 2026-07-31
    by: "Hermes Agent"
    model: "glm-5.2"
    mcp_verified: true
    note: "Neuerstellung KW31 — neue Auslegung BGer 9C_610/2025 (Art. 18a IVG / GAV FAR); Gesetzestext via Fedlex MCP, 15 Entscheide via OCL verifiziert."
---
...
**12** Der Bundesrat regelt die Voraussetzungen für einen möglichen **vorzeitigen Abbruch** des Arbeitsversuchs (Art. 18a Abs. 4 IVG) in Art. 14a Abs. 3 IVV (Verordnung über die Invalidenversicherung). Ein vorzeitiger Abbruch kann durch die IV-Stelle angeordnet werden, wenn die versicherte Person die massgebenden Voraussetzungen nicht erfüllt oder wenn der Arbeitsversuch seinen Zweck nicht mehr erfüllen kann. Der vorzeitige Abbruch ist zu unterscheiden vom regulären Ablauf der 180-Tage-Frist. Die Folgen des vorzeitigen Abbruchs für den Taggeldanspruch und die Rentenfestsetzung richten sich nach dem jeweiligen Einzelfall ([BGer 9C_539/2024](https://mcp.opencaselaw.ch/entscheid/bger_9C_539_2024)).

**13** Die Ergebnisse des Arbeitsversuchs fliessen in die **Invaliditätsbeurteilung** (Art. 16 ATSG) ein. Zeigt der Arbeitsversuch, dass die versicherte Person trotz der gesundheitlichen Einschränkungen auf dem Arbeitsmarkt leistungsfähig ist, kann dies zu einer Herabsetzung oder Aufhebung der Rente führen (Art. 17 ATSG — Revision). Das Ergebnis des Arbeitsversuchs ist ein wichtiges Indiz für die Frage, ob und in welchem Umfang die versicherte Person vermittlungsfähig und damit auf dem Arbeitsmarkt eingliederbar ist ([BGer 9C_604/2014](https://mcp.opencaselaw.ch/entscheid/bger_9C_604_2014)).

## Querverweise

- [Art. 8 IVG](../art-008/) — Grundsatz (Eingliederungsmassnahmen)
- [Art. 14a IVG](../art-014a/) — Integrationsmassnahmen
- [Art. 28 IVG](../art-028/) — Rentenanspruch
