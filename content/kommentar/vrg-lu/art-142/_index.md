...
1. **Welche Entscheide anfechtbar sind** (Anknüpfung an den Entscheidsbegriff des § 4 VRG);
2. **Welche Instanzen als Vorinstanzen massgeblich sind** (Gemeindebehörden, untere kantonale Instanzen, Departemente);
3. **Welche Beschwerdeinstanzen zuständig sind** (sachlich zuständiges Departement gemäss lit. b; Regierungsrat gemäss lit. c);
4. **Dass abweichende Zuständigkeitsordnungen vorgehen** (Abs. 2).
