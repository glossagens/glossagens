...
date: 2026-07-27
lastmod: "2026-08-29"
description: "Übersicht der Rechtsprechung zu Art. 20 UVG — Höhe der Invalidenrente, Komplementärrente, Überentschädigung, Alterskürzung und versicherter Verdienst."
...
revisions:
  - date: 2026-08-29
    ...
    mcp_verified: true
    note: "Vollständige Überarbeitung und Ausbau der Rechtsprechungsübersicht: Aufnahme von Leitentscheiden (BGE 149 V 129, BGE 145 V 75, BGE 147 V 213, BGE 130 V 39, BGE 126 V 506, BGE 124 V 301, BGE 123 V 133, BGE 122 V 338, BGE 122 V 343, BGE 119 V 484, BGE 115 V 416) sowie kantonaler Urteile mit entscheidsuche.ch-Verlinkungen."
  - date: 2026-07-27
    by: "Glossagens Agent"
    model: "claude-opus-4-8"
    mcp_verified: true
    note: "Ersterfassung der Rechtsprechungsübersicht zu Art. 20 UVG"
---

# Rechtsprechung zu Art. 20 UVG
...
- **Einschlägig für**: Abs. 2 — Komplementärrente und Verhältnis zu Art. 69 ATSG
...
- **Einschlägig für**: Abs. 2 — Anrechnung von Familienrenten
...
- **Einschlägig für**: Abs. 1 — Versicherter Verdienst bei Rentenrevision

---

### [BGE 130 V 39](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_007_BGE-130-V-39_2004.html#consideration_4.3), E. 4.3
- **Thema**: Zusammentreffen von UVG-Rente und AHV-Altersrente nach krankheitsbedingter IV-Rente
- **Sachverhalt**: Ein Versicherter bezog eine UVG-Teilrente für unfallbedingte Restinvalidität und daneben eine reine Krankheits-IV-Rente (ohne Komplementärrente). Mit 65 Jahren löste die AHV-Altersrente die IV-Rente ab, worauf die Suva die UVG-Rente wegen Erreichens des 90 %-Plafonds als Komplementärrente auf Fr. 0.– herabsetzte.
- **Kernaussage**: Die vor Eintritt des AHV-Rentenalters zugesprochene UVG-Rente ist beim Zusammentreffen mit der Altersrente der AHV, die eine ausschliesslich krankheitsbedingte IV-Rente ablöst, zwingend als Komplementärrente festzusetzen. Es besteht diesbezüglich keine vom Gericht auszufüllende Verordnungslücke.
- **Einschlägig für**: Abs. 2 — Zusammentreffen mit AHV-Altersrente
...
- **Einschlägig für**: Abs. 2 — Anpassungstatbestände
...
- **Einschlägig für**: Abs. 1 — Versicherter Verdienst bei Schnupperlehrlingen
...
- **Einschlägig für**: Abs. 1 — Höchstbetrag des versicherten Verdienstes
...
- **Einschlägig für**: Abs. 2 — Neufestsetzung bei Familienrenten
...
- **Einschlägig für**: Abs. 2 — Revision des Invaliditätsgrades
...
- **Einschlägig für**: Abs. 2 — Teuerungszulagen
...
- **Einschlägig für**: Abs. 1 & 2 — Rechtsschutzinteresse, versicherter Verdienst
...
### [Zürich Sozialversicherungsgericht UV.2023.00030 vom 13.02.2024](https://entscheidsuche.ch/docs/ZH_Sozialversicherungsgericht/ZH_SVG_001_UV-2023-00030_2024-02-13.html), E. 4
- **Kanton**: Zürich
- **Thema**: Keine Derogation der Komplementärrentenanrechnung durch zivilrechtliche Vergleiche
- **Kernaussage**: Ein privatrechtlicher Vergleich über Haftpflichtansprüche zwischen dem Versicherten und dem Haftpflichtigen oder Privatversicherer kann den zwingenden öffentlich-rechtlichen Koordinationsmechanismus von Art. 20 Abs. 2 UVG nicht aushebeln. Beim Zusammentreffen der UVG-Rente mit der AHV-Altersrente ist die AHV-Rente voll anzurechnen.
- **Einschlägig für**: Abs. 2 — Zwingendes Recht vs. Parteivereinbarungen

---

### [Zürich Sozialversicherungsgericht UV.2018.00269 vom 29.06.2020](https://entscheidsuche.ch/docs/ZH_Sozialversicherungsgericht/ZH_SVG_001_UV-2018-00269_2020-06-29.html), E. 3
- **Kanton**: Zürich
- **Thema**: Erstmaliges Zusammentreffen einer UVG-Invalidenrente mit einer AHV-Altersrente
- **Kernaussage**: Bestätigung der bundesgerichtlichen Praxis (BGE 130 V 39), wonach bei Erreichen des Referenzalters die AHV-Altersrente voll auf die UVG-Rente anzurechnen ist, selbst wenn vor Erreichen des Rentenalters keine Komplementärrente ausgerichtet wurde.
- **Einschlägig für**: Abs. 2 — Erstmaliges Zusammentreffen mit AHV-Rente

---

### [St. Gallen Versicherungsgericht UV 2011/75 vom 31.07.2012](https://entscheidsuche.ch/docs/SG_Gerichte/SG_VSG_001_UV-2011-75_2012-07-31.pdf), E. 3
- **Kanton**: St. Gallen
- **Thema**: Ereignisbezogene Kongruenz bei Verschlechterung und Vorinvalidität
- **Kernaussage**: Art. 32 Abs. 1 und 2 UVV ist analog auf Fälle anzuwenden, in denen erst durch die unfallbedingte Verschlechterung eines krankheitsbedingten Vorzustands ein rentenbegründender Invaliditätsgrad entsteht und der Unfallanteil feststeht. Dadurch wird die ereignisbezogene Kongruenz verfassungskonform gewahrt.
- **Einschlägig für**: Abs. 2 — Ereignisbezogene Kongruenz

---

### [St. Gallen Versicherungsgericht UV 2010/24 vom 12.07.2011](https://entscheidsuche.ch/docs/SG_Gerichte/SG_VSG_001_UV-2010-24_2011-07-12.pdf), E. 2
- **Kanton**: St. Gallen
- **Thema**: Vorrang der Komplementärrente vor Art. 66 und 69 ATSG bei AHV-Altersrente
- **Kernaussage**: Art. 20 UVG und Art. 31–33 UVV bilden eine Spezialordnung zur Leistungskoordination, die den allgemeinen ATSG-Kürzungsnormen (Art. 66 und 69 ATSG) vorgeht. Bei Umwandlung einer IV-Rente in eine AHV-Altersrente ist die Komplementärrente auf Beginn des AHV-Alters neu festzusetzen.
- **Einschlägig für**: Abs. 2 — Spezialordnung UVG vs. ATSG

---

### [Aargau Obergericht Versicherungsgericht VBE.2024.96 vom 12.06.2024](https://entscheidsuche.ch/docs/AG_Gerichte/AG_OG_007_VBE-2024-96_2024-06-12.pdf), E. 4.2
- **Kanton**: Aargau
- **Thema**: Ablösung der IV-Rente durch die AHV-Altersrente
- **Kernaussage**: Bestätigung der Praxis zu Art. 20 Abs. 2 UVG bei Ablösung der IV-Rente durch die Altersrente der AHV und Prüfung des Anpassungstatbestands im Lichte von BGE 130 V 39 und BGE 126 V 506.
- **Einschlägig für**: Abs. 2 — Ablösung IV/AHV

---

### [Schwyz Verwaltungsgericht I 2022 24 vom 08.07.2022](https://entscheidsuche.ch/docs/SZ_Verwaltungsgericht/SZ_VG_003_I-2022-24_2022-07-08.pdf), E. 6.6
- **Kanton**: Schwyz
- **Thema**: Keine Überprüfung des Jahresverdienstes bei Rentenrevision
- **Kernaussage**: Im Rahmen der materiellen Revision einer Invalidenrente (Art. 17 ATSG) kann der bei Rentenbeginn festgesetzte versicherte Jahresverdienst nach BGE 119 V 484 Erw. 4b nicht mehr frei überprüft oder korrigiert werden.
- **Einschlägig für**: Abs. 1 — Bindung an versicherten Verdienst
