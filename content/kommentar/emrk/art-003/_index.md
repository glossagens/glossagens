...
tags: ["EMRK", "Folterverbot", "unmenschliche Behandlung", "erniedrigende Behandlung", "Einvernahme", "Absolutheit", "EGMR"]
...
revisions:
  - date: 2026-08-16
    ...
    mcp_verified: true
    note: "Audit (Urteil C, faktisch 0% -> Neuaufbau): alle 6 zitierten BGE (122 II 353, 125 II 273, 134 I 87/087, 140 IV 144, 144 I 177, 146 IV 161) waren fabriziert -- ersetzt durch 5 via check_claim_support verifizierte echte BGE (131 I 455, 143 I 304 E.2.3, 140 I 125, 111 Ib 68, 148 IV 314). EGMR-Zitate liegen ausserhalb des opencaselaw-Parsers (nur BGE/BGer-Zitierlagen erkannt) -- Fallnamen/Aktenzeichen sind echte, bekannte Leitentscheide, aber nicht alle Absatz-Pinpoints waren über den (Schweiz-skopierten) EGMR-Bestand verifizierbar und wurden entfernt statt geraten; Soering §§ 90-91 über Kreuzzitate in Schweiz-EGMR-Entscheiden bestätigt. Mursic-Aktenzeichen war falsch (32573/13 statt 7334/13) -- korrigiert. agent_verified auf false, da EGMR-Pinpoints nicht vollständig MCP-verifizierbar sind."
---
...
**1** Art. 3 EMRK ist einer der fundamentalsten Menschenrechtssätze überhaupt. Er ist absolut — er kennt keine Ausnahme, keine Einschränkung und keinen Vorbehalt. Weder der Kriegsfall, noch der Terrorismus, noch der Notstand rechtfertigen eine Abweichung ([EGMR, Ireland v. United Kingdom](https://hudoc.echr.coe.int/eng?i=001-57350); [EGMR, Selmouni v. France](https://hudoc.echr.coe.int/eng?i=001-41680)).
...
Die Abgrenzung zwischen den Stufen ist tatrichterlich und hängt von den konkreten Umständen ab ([EGMR, Ireland v. United Kingdom](https://hudoc.echr.coe.int/eng?i=001-57350); [EGMR, Kudła v. Poland](https://hudoc.echr.coe.int/eng?i=001-58596)).

### III. Folter (Stufe 1)

**4** **Definition.** Folter ist jede Handlung, durch die einer Person vorsätzlich grosse körperliche oder seelische Leiden zugefügt werden, um beispielsweise Informationen oder ein Geständnis zu erlangen, sie zu bestrafen, einzuschüchtern oder zu nötigen. Der EGMR verlangt ein **mindestens erhebliches Intensitätsniveau** der Leiden ([EGMR, Ireland v. United Kingdom](https://hudoc.echr.coe.int/eng?i=001-57350); [EGMR, Selmouni v. France](https://hudoc.echr.coe.int/eng?i=001-41680)).
...
- **Schutzpflicht**: Der Staat muss schutzbedürftige Personen vor Misshandlung durch Dritte schützen ([EGMR, Osman v. United Kingdom](https://hudoc.echr.coe.int/eng#%7B%22appno%22:%5B%2223452/94%22%5D%7D)).
- **Untersuchungspflicht**: Bei hinreichendem Verdacht auf Misshandlung muss der Staat eine **effektive Untersuchung** durchführen ([EGMR, Assenov v. Bulgaria](https://hudoc.echr.coe.int/eng#%7B%22appno%22:%5B%2224760/94%22%5D%7D); [EGMR, Kudła v. Poland](https://hudoc.echr.coe.int/eng#%7B%22appno%22:%5B%2230210/96%22%5D%7D)).
- **Präventionspflicht**: Der Staat muss vorbeugende Massnahmen treffen, insbesondere in Haftanstalten und bei der Polizeiarbeit.

**13** **Untersuchungspflicht bei Polizeigewalt.** Wer in vertretbarer Weise behauptet, von einem Polizeibeamten erniedrigend behandelt worden zu sein, hat auch nach schweizerischer Praxis Anspruch auf eine wirksame und vertiefte amtliche Untersuchung dieser Vorwürfe ([BGE 131 I 455](https://mcp.opencaselaw.ch/entscheid/bge_BGE_131_I_455)).

### VII. Non-Refoulement

**14** **Rückführungsverbot.** Art. 3 EMRK begründet ein **absolutes Rückführungsverbot** (Non-Refoulement): Ein Staat darf keine Person in ein Land zurückweisen oder ausweisen, in dem sie konkret Gefahr läuft, Folter oder unmenschlicher Behandlung unterworfen zu werden ([EGMR, Soering v. United Kingdom](https://hudoc.echr.coe.int/eng#%7B%22appno%22:%5B%2214038/88%22%5D%7D) §§ 90–91). Dies gilt grundsätzlich auch dann, wenn der Empfangsstaat diplomatische Zusicherungen abgibt: Sind konkrete Hinweise auf eine unmenschliche oder erniedrigende Behandlung im ersuchenden Staat vorhanden, ist zu prüfen, ob solche Garantien das Risiko wirksam ausschliessen ([BGE 148 IV 314](https://mcp.opencaselaw.ch/entscheid/bge_BGE_148_IV_314), Auslieferung an Armenien).

**15** **Schweizer Asylpraxis.** Auch nach ständiger bundesgerichtlicher Praxis kann die Abschiebung einer Person in ein Land, in welchem ihr eine schwerwiegende menschenrechtswidrige Behandlung droht, Art. 3 EMRK verletzen ([BGE 111 Ib 68](https://mcp.opencaselaw.ch/entscheid/bge_BGE_111_Ib_68) E. 2).
...
- [Art. 7 BV](../../bv/art-007/) — Menschenwürde
