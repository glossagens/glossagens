---
title: "Art. 139 — Grundsätze"
weight: 139
date: 2025-05-09
lastmod: 2025-05-09
description: "Kommentar zu Art. 139 StPO – Grundsätze der Beweisführung im Strafverfahren"
tags: ["StPO", "Beweisrecht", "Wahrheitsfindung", "antizipierte Beweiswürdigung", "Offenkundigkeit"]
agent_verified: true
---
...
- **Adressaten**: Alle Strafbehörden (Staatsanwaltschaft, Gerichte, Polizei als Strafverfolgungsbehörde, vgl. [BGer 6B_1057/2013](https://mcp.opencaselaw.ch/entscheid/bger_6B_1057_2013) vom 19. Mai 2014, E. 2.3).
...
- **Abgrenzung zum In-dubio-Grundsatz**: Der Grundsatz *in dubio pro reo* findet auf die Beweiserhebung keine Anwendung — er greift erst nach Erhebung aller notwendigen Beweise im Rahmen der Beweiswürdigung ([BGE 144 IV 345](https://mcp.opencaselaw.ch/entscheid/bge_BGE_144_IV_345), E. 2.2.3).
...
- **Offenkundige (gerichtsnotorische) Tatsachen**: Tatsachen, die so allgemein bekannt sind, dass sie jeder richterlichen Kenntnisnahme ohne weiteres zugänglich sind. Im Internetbereich gelten als gerichtsnotorisch grundsätzlich nur Informationen mit «offiziellem Anstrich» wie Bundesamt für Statistik, Handelsregistereintrag, Wechselkurse oder SBB-Fahrplan ([BGE 143 IV 380](https://mcp.opencaselaw.ch/entscheid/bge_BGE_143_IV_380), E. 1). Die Qualifikation als gerichtsnotorisch ist mit Zurückhaltung vorzunehmen.
...
- **Bereits rechtsgenügend erwiesene Tatsachen**: Liegt ein Beweisergebnis vor, das bei objektiver Betrachtung ausreichend erscheint, um die Überzeugung des Gerichts zu tragen, so bedarf es keines weiteren Beweises. Dies ist die gesetzliche Grundlage für die **antizipierte Beweiswürdigung** ([BGE 147 IV 534](https://mcp.opencaselaw.ch/entscheid/bge_BGE_147_IV_534), E. 2.5.1).

### Abgrenzungen

- **Art. 6 StPO (Untersuchungsgrundsatz)**: Art. 139 Abs. 1 konkretisiert den Untersuchungsgrundsatz für das Beweisrecht. Die Pflicht zur Wahrheitsfindung besteht nur für *geeignete* und *rechtlich zulässige* Beweismittel — nicht für blosse Beweisermittlungsanträge (Fishing Expeditions), vgl. [BGer 6B_1051/2019](https://mcp.opencaselaw.ch/entscheid/bger_6B_1051_2019) vom 9. April 2020, E. 4.2.
- **Art. 10 Abs. 2 StPO (Freie Beweiswürdigung)**: Art. 139 StPO regelt die *Beweiserhebung*, Art. 10 Abs. 2 StPO die *Beweiswürdigung*. Die Unschuldsvermutung und der In-dubio-Grundsatz greifen erst im Rahmen der Beweiswürdigung ([BGE 144 IV 345](https://mcp.opencaselaw.ch/entscheid/bge_BGE_144_IV_345), E. 2.2.3).
...
**1. Gerichtsnotorische Tatsachen im Internet ([BGE 143 IV 380](https://mcp.opencaselaw.ch/entscheid/bge_BGE_143_IV_380), E. 1):**
...
**2. Antizipierte Beweiswürdigung ([BGE 147 IV 534](https://mcp.opencaselaw.ch/entscheid/bge_BGE_147_IV_534), E. 2.5.1):**

Die Strafbehörden können ohne Verletzung des rechtlichen Gehörs auf die Abnahme weiterer Beweise verzichten, wenn sie in vorweggenommener (antizipierter) Beweiswürdigung annehmen können, dass ihre Überzeugung durch weitere Beweiserhebungen nicht geändert werde. Dies setzt eine begründete hypothetische Würdigung des möglichen Beweisinhalts voraus — rein formelhafte Verweise genügen nicht ([BGer 6B_574/2021](https://mcp.opencaselaw.ch/entscheid/bger_6B_574_2021) vom 22. November 2021, E. 1.2). Die Rüge unzulässiger antizipierter Beweiswürdigung wird vom Bundesgericht als Tatfrage nur unter dem Willküraspekt geprüft (Art. 97 Abs. 1 BGG).

**3. In-dubio pro reo und Beweiserhebung ([BGE 144 IV 345](https://mcp.opencaselaw.ch/entscheid/bge_BGE_144_IV_345), E. 2.2.3):**
...
**4. Polizeirapport als Beweismittel ([BGer 6B_1057/2013](https://mcp.opencaselaw.ch/entscheid/bger_6B_1057_2013) vom 19. Mai 2014, E. 2.3):**
...
**5. Beweisermittlungsantrag vs. Beweisantrag ([BGer 6B_1051/2019](https://mcp.opencaselaw.ch/entscheid/bger_6B_1051_2019) vom 9. April 2020, E. 4.2):**
