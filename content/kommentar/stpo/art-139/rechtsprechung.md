...
### BS_APPELLATIONSGERICHT SB.2024.8 vom 17. Oktober 2024
- **Kanton**: Basel-Stadt
- **Thema**: Offenkundige Tatsachen, antizipierte Beweiswürdigung
- **Kernaussage**: Direkte Anwendung von Art. 139 Abs. 1 und 2 StPO. Die Konstellationen, in denen keine Beweiserhebung erfolgt (unerheblich, offenkundig, bekannt, rechtsgenügend erwiesen), stellen die gesetzliche Umschreibung der Fälle dar, in denen eine antizipierte Beweiswürdigung zulässig ist.

---

### ZH_OBERGERICHT UH160068 vom 25. April 2016
- **Kanton**: Zürich
- **Thema**: Beweisantragsablehnung, Art. 139 Abs. 2 StPO
- **Kernaussage**: Das Obergericht Zürich legt Art. 139 Abs. 2 StPO restriktiv aus: Die Staatsanwaltschaft darf grundsätzlich nur solche Beweisanträge ablehnen, die unerhebliche, offenkundige, bekannte oder bereits rechtsgenügend erwiesene Tatsachen betreffen.

---

### SG_KANTONSGERICHT ST.2013.51/57/59/61 vom 8. Dezember 2014
- **Kanton**: St. Gallen
- **Thema**: Beweisvereitelung, Wahrheitsfindung
- **Kernaussage**: Unterlassen die Strafbehörden die Abnahme gebotener Beweise und können diese aus Gründen, die nicht in der Person des Beschuldigten liegen, auch später nicht mehr erhoben werden, so ist die entlastend wirkende Beweisbehauptung dem übrigen Beweisergebnis gegenüberzustellen. Im Extremfall kann die Beweisvereitelung der Untersuchungsbehörden dazu führen, dass vom Nachweis zugunsten der beschuldigten Person ausgegangen werden muss (Wahrunterstellung).

---

### BL_GERICHTE 470 16 50 vom 24. Mai 2016
- **Kanton**: Basel-Landschaft
- **Thema**: Beweisantragsablehnung, rechtliches Gehör
- **Kernaussage**: Das Kantonsgericht BL hob eine Einstellung auf, weil die Untersuchung wesentliche Lücken aufwies. Die Abweisung von Beweisanträgen verstösst gegen das rechtliche Gehör, wenn die beantragten Beweise geeignet und erheblich sind, den Sachverhalt aufzuklären.

---

### AG_STRAFGERICHT SBK.2024.285 vom 17. Dezember 2024
- **Kanton**: Aargau
- **Thema**: Nichtanhandnahme, offenkundig
- **Kernaussage**: Die Staatsanwaltschaft verfügt die Nichtanhandnahme, sobald aufgrund der Strafanzeige oder des Polizeirapports feststeht, dass die Straftatbestände eindeutig nicht erfüllt sind (Art. 310 Abs. 1 lit. a StPO). Auch wenn ein Straftatbestand erfüllt ist, aber offenkundig ein Rechtfertigungsgrund vorliegt, kann eine Nichtanhandnahme erfolgen — Illustration der praktischen Bedeutung von «offenkundig» i.S.v. Art. 139 Abs. 2 StPO.
