...
Im Rechtsmittelverfahren stellen sich besondere Kostenfragen, die in [Art. 428](../art-428) und Art. 436 StPO geregelt sind. Für Art. 432 StPO ist folgende Konstellation besonders relevant:
...
Art. 432 StPO steht in engem Zusammenhang mit [Art. 427](../art-427) StPO (Kostentragungspflicht der Privatklägerschaft) und Art. 433 StPO (Entschädigung der Privatklägerschaft). Während Art. 427 StPO die **Verfahrenskosten** (Gebühren, Auslagen) betrifft, regelt Art. 432 StPO die **Parteientschädigung** — also den Ersatz von Aufwendungen der beschuldigten Person für ihre Verteidigung. Art. 433 StPO wiederum gewährt der Privatklägerschaft selbst einen Entschädigungsanspruch, wenn sie obsiegt.
...
1. **Freispruch bei Antragsdelikten**: Hat die Privatklägerschaft den Strafantrag gestellt und sich aktiv am Verfahren beteiligt, kann sie nach Absatz 2 zur Entschädigung verpflichtet werden, sofern die Voraussetzungen der Mutwilligkeit oder groben Fahrlässigkeit gegeben sind.
2. **Abweisung der Zivilklage**: Wird die beschuldigte Person im Schuldpunkt verurteilt, aber die Zivilklage der Privatklägerschaft abgewiesen oder auf den Zivilweg verwiesen, so hat die beschuldigte Person nach Absatz 1 Anspruch auf Entschädigung der durch die Zivilanträge verursachten Aufwendungen.
3. **Rechtsmittelverfahren**: Wird die einzig von der Privatklägerschaft erhobene Berufung abgewiesen, trägt die Privatklägerschaft die Verteidigungskosten der beschuldigten Person.
4. **Einstellung des Verfahrens**: Wird das Verfahren eingestellt, so geht die Entschädigung bei Offizialdelikten zulasten des Staats, bei Antragsdelikten (regelmässig) zulasten der Privatklägerschaft (BGE 147 IV 47 E. 4.2.2).
