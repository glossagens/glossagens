...
revisions:
  ...
  - date: "2026-08-30"
    ...
    mcp_verified: true
    note: "Vollständige Neukommentierung zu Art. 398 StPO; Gesetzestext via Fedlex abgeglichen, Rechtsprechung und Belege via entscheidsuche verifiziert."
---
...
**Rz. 1** Art. 398 StPO ist die verfahrensrechtliche Grundnorm für die **Berufung als ordentliches, vollkommenes Rechtsmittel** des schweizerischen Strafprozessrechts. Das Rechtsmittel gewährleistet den verfassungs- und menschenrechtlichen Anspruch auf einen doppelten gerichtlichen Instanzenzug (*double instance*; Art. 32 Abs. 3 BV; Art. 2 des 7. ZP zur EMRK). Es statuiert das Prinzip der **umfassenden Kognition** (*de novo review*): Das Berufungsgericht überprüft das Urteil der ersten Instanz in Tat-, Rechts- und Ermessensfragen frei und unabhängig ([BGE 144 IV 383](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_006_BGE-144-IV-383_2018.html) E. 1.1; [BGE 141 IV 244](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_006_BGE-141-IV-244_2015.html) E. 1.2).

**Rz. 2** **Systematische Einordnung.** Art. 398 StPO eröffnet den 1. Abschnitt («Berufung») des 9. Titels. Die Norm grenzt das Anwendungsgebiet der Berufung (End- und Sachurteile) von demjenigen der Beschwerde (Art. 393 StPO; Zwischen- und Zwangsmassnahmenentscheide) ab.

---

## Abs. 1 bis 3 — Anfechtungsobjekte und freie Kognition

**Rz. 3** **Anfechtbare Entscheide (Abs. 1):**
1. End- und Teilurteile erstinstanzlicher Gerichte (Einzelgerichte, Kollegialgerichte, Wirtschaftsstrafgerichte);
2. Selbständige nachträgliche Entscheide des Gerichts (z.B. Widerruf bedingter Strafen nach Art. 363 ff. StPO);
3. Selbständige Einziehungsentscheide nach Art. 376 ff. StPO ([BGer 7B_127/2023 vom 14. März 2024](https://entscheidsuche.ch/docs/CH_BGer/CH_BGer_007_7B-127-2023_2024-03-14.html) E. 2.1).

**Rz. 4** **Die drei Rügegründe (Abs. 3):**
- **Rechtsverletzungen (lit. a):** Falsche Anwendung von Bundes-, Völker- oder kantonalem Recht sowie Ermessensfehler und Verletzungen von Verfahrensgrundrechten (z.B. rechtliches Gehör, Beschleunigungsgebot);
- **Sachverhaltsrüge (lit. b):** Unrichtige oder unvollständige Sachverhaltsfeststellung (freie Beweiswürdigung durch die zweite Instanz);
- **Unangemessenheit (lit. c):** Rüge einer unzweckmässigen oder zu harten Strafzumessung bzw. Massnahmengestaltung ([BGer 6B_776/2021 vom 8. November 2021](https://entscheidsuche.ch/docs/CH_BGer/CH_BGer_006_6B-776-2021_2021-11-08.html) E. 1.2).
...
### 1. Volle Kognition bei gemischten Verfahren (Vergehen und Übertretung)
**Rz. 7** Hat das erstinstanzliche Gericht über ein Vergehen (z.B. einfache Körperverletzung) und eine Übertretung (z.B. Tätlichkeit oder Konsumdelikt) gemeinsam geurteilt, gilt die Noven- und Kognitionsschranke von Abs. 4 nicht; das Berufungsgericht überprüft das Urteil in allen Punkten mit voller Kognition ([SG Kantonsgericht AK.2024.226 vom 12. September 2024](https://entscheidsuche.ch/docs/SG_Gerichte/SG_KG_001_AK-2024-226_2024-09-12.pdf)).

### 2. Zulässigkeit von Noven bei Landesverweisungen
**Rz. 8** Im Rahmen der Überprüfung einer obligatorischen oder nicht-obligatorischen Landesverweisung (Art. 66a/66a bis StGB) können bis zum Abschluss der Berufungsverhandlung neue Tatsachen zur persönlichen und familiären Integration (Härtefallkriterien) unbeschränkt vorgebracht werden ([SZ Kantonsgericht STK 2026 18 vom 4. Mai 2026](https://entscheidsuche.ch/docs/SZ_Gerichte/SZ_KG_003_STK-2026-18_2026-05-04.pdf)).
