---
title: "Art. 12 — Strafverfolgungsbehörden"
weight: 12
date: 2026-07-12
lastmod: "2026-08-22"
description: "Kommentar zu Art. 12 StPO – Strafverfolgungsbehörden"
tags: ["StPO", "Strafverfolgungsbehörden", "Organisation", "Zuständigkeit"]
agent_verified: true
revisions:
  - date: 2026-08-22
    by: "Claude Code"
    model: "claude-opus-5"
    mcp_verified: true
    note: "Vollständiger Overhaul nach Audit (Belegquote 40 %). Neun Ausstandsentscheide waren als Belege zu Art. 12 StPO geführt; sieben davon erwähnen die Norm im gesamten Volltext nicht. Sie sind entfernt und durch die beiden echten Fundstellen ersetzt (1B_139/2018 E. 4.1: abgestufte Unparteilichkeitsanforderungen; 1B_405/2014 E. 4.2: Unabhängigkeit unter Vorbehalt der Weisungsbefugnisse). Art. 2 StPO berichtigt — der Behördenvorbehalt steht in Abs. 1, nicht Abs. 2. Art. 18 StPO als «Gerichte» berichtigt (ist das Zwangsmassnahmengericht). Grobraster-Zitat aus BGE 142 IV 70 korrigiert («Bund und Kantonen», nicht «den Kantonen») und Botschaft-Fundstelle von BBl 2006 1095 auf 1134 Ziff. 2.2.1.1 richtiggestellt. «Hilfsbehörde der Staatsanwaltschaft» durch den Gesetzeswortlaut ersetzt. Neu belegt: BGer 6B_1304/2018 E. 1.4."
  - date: 2026-08-13
    by: "Hermes Agent"
    model: "glm-5.1"
    mcp_verified: true
...
Art. 12 StPO steht in engem Zusammenhang mit dem Untersuchungsgrundsatz (Art. 6 StPO). Art. 6 Abs. 1 StPO spricht von den «Strafbehörden» und erfasst damit sowohl die Strafverfolgungsbehörden nach Art. 12 StPO als auch die Gerichte nach [Art. 13 StPO](../art-013/) (Art. 18 StPO regelt demgegenüber nur das Zwangsmassnahmengericht). «Im Strafverfahren gilt der Untersuchungsgrundsatz. Danach klären die Strafbehörden von Amtes wegen alle für die Beurteilung der Tat und der beschuldigten Person bedeutsamen Tatsachen ab (Art. 6 Abs. 1 StPO). Sie untersuchen die belastenden und entlastenden Umstände mit gleicher Sorgfalt» ([BGE 147 IV 409](https://mcp.opencaselaw.ch/entscheid/bge_BGE_147_IV_409) E. 5.3.1). Der Entscheid selbst betrifft die Ermittlungspflicht des **Berufungsgerichts** (Art. 389 StPO) und nennt Art. 12 StPO nicht. Die Nennung der Strafverfolgungsbehörden in Art. 12 StPO begrenzt damit den Kreis der Akteure, die im Rahmen des Untersuchungsgrundsatzes von Amtes wegen den Sachverhalt erforschen und Beweise erheben.

### V. Ausstand und Unabhängigkeit

Der Ausstandsgrundkatalog von [Art. 56 StPO](../art-056/) gilt für «eine in einer Strafbehörde tätige Person» und erfasst damit ohne Weiteres alle in Art. 12 StPO genannten Behörden; einer eigenen Rechtsprechung bedarf dies nicht.

Praktisch bedeutsam ist jedoch, dass Art. 12 StPO für die Ausstandsprüfung einen **abgestuften Massstab** begründet. «Dem funktionellen Unterschied zwischen einem Gericht (Art. 13 StPO) und einer Strafverfolgungsbehörde (Art. 12 StPO) ist Rechnung zu tragen. Die Anforderungen an die Unparteilichkeit sind bei einem Polizeibeamten aufgrund der Natur seiner Funktion weniger hoch als bei einem Staatsanwalt und erst recht einem Richter» ([BGer 1B_139/2018 vom 26. November 2018](https://mcp.opencaselaw.ch/entscheid/bger_1B_139_2018) E. 4.1, mit Verweis auf [BGE 141 IV 178](https://mcp.opencaselaw.ch/entscheid/bge_BGE_141_IV_178) E. 3.2.2). Die Zugehörigkeit zu einer der drei Kategorien von Art. 12 StPO ist damit nicht bloss ein Etikett, sondern bestimmt die Höhe der Anforderung mit.

Damit verbunden ist die Reichweite der Unabhängigkeit: «Die Strafbehörden sind in der Rechtsanwendung unabhängig und allein dem Recht verpflichtet ([Art. 4](../art-004/) Abs. 1 StPO). Gesetzliche Weisungsbefugnisse gegenüber den Strafverfolgungsbehörden (Art. 12 StPO) nach [Art. 14](../art-014/) StPO bleiben vorbehalten» ([BGer 1B_405/2014 vom 12. Mai 2015](https://mcp.opencaselaw.ch/entscheid/bger_1B_405_2014) E. 4.2). Die Strafverfolgungsbehörden nach Art. 12 StPO stehen also — anders als die Gerichte — unter dem Vorbehalt gesetzlicher Weisungsbefugnisse (vgl. Art. 15 Abs. 2 und Art. 16 Abs. 1 StPO).
...
- [Art. 320 StPO](../art-320/) — Einstellungsverfügung
