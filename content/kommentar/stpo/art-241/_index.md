---
title: "Art. 241 StPO — Anordnung von Durchsuchungen und Untersuchungen"
weight: 241
date: "2026-08-30"
lastmod: "2026-08-30"
description: "Kommentar zu Art. 241 StPO – Anordnung von Durchsuchungen und Untersuchungen: Schriftlicher Durchsuchungsbefehl, Bestimmtheitsgebot, Gefahr im Verzug (Abs. 3) und Sicherheitsdurchsuchung (Abs. 4)."
tags: ["StPO", "Durchsuchung", "Durchsuchungsbefehl", "Schriftform", "Gefahr im Verzug", "Sicherheitsdurchsuchung", "Zwangsmassnahmen", "Verhältnismässigkeit"]
agent_verified: true
revisions:
  - date: "2026-08-30"
    ...
    mcp_verified: true
    note: "Vollständige Neukommentierung zu Art. 241 StPO; Gesetzestext via Fedlex abgeglichen, Rechtsprechung und Belege via entscheidsuche verifiziert."
---
...
**Rz. 4** **Mündliche Anordnung bei Dringlichkeit (Abs. 1 Satz 2).** In dringenden Fällen (z.B. bei nächtlichen Einsätzen oder Fluchtgefahr) kann die Staatsanwaltschaft den Befehl mündlich (telefonisch) erteilen. Der Befehl ist nachträglich schriftlich auszufertigen und zu den Akten zu nehmen ([BGer 1B_179/2012 vom 13. April 2012](https://entscheidsuche.ch/docs/CH_BGer/CH_BGer_001_1B-179-2012_2012-04-13.html) E. 3.2).

**Rz. 5** **Zwingender Mindestinhalt (Abs. 2 lit. a–c):**
1. **Objekt/Subjekt (lit. a):** Genaue Bezeichnung der Räume (Adresse, Stockwerk), Personen oder Datenträger ([BGE 144 IV 74](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_006_BGE-144-IV-74_2018.html) E. 2.3);
2. **Zweckbindung (lit. b):** Konkrete Umschreibung des Deliktsvorwurfs und der gesuchten Beweismittel. Eine pauschale Floskel wie «Suche nach sachdienlichen Hinweisen» ist unzulässig und macht den Befehl rechtswidrig ([ZH Obergericht UH130171 vom 29. Juli 2013](https://entscheidsuche.ch/docs/ZH_Obergericht/ZH_OG_002_UH130171_2013-07-29.pdf));
...
**Rz. 6** **Gefahr im Verzug.** Ist Gefahr im Verzug, darf die Polizei Durchsuchungen selbständig und ohne vorgängigen Befehl vornehmen. Gefahr im Verzug liegt vor, wenn das Zuwarten bis zur Erreichung der Staatsanwaltschaft den Untersuchungserfolg vereiteln würde (z.B. drohende Spurenvernichtung, Wegschaffen von Betäubungsmitteln; [BGE 138 IV 153](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_006_BGE-138-IV-153_2012.html) E. 3; [BGE 139 IV 128](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_006_BGE-139-IV-128_2013.html) E. 1.4).

**Rz. 7** **Informationspflicht.** Die Polizei hat die zuständige Staatsanwaltschaft nach Vornahme der befehlsfreien Durchsuchung unverzüglich zu orientieren und zu rapportieren ([TG Obergericht RBOG 2025 Nr. 30](https://entscheidsuche.ch/docs/TG_OG/TG_OG_001_RBOG-2025-Nr--30_2025.html)).

---

## Abs. 4 — Polizeiliche Sicherheitsdurchsuchung

**Rz. 8** **Eigensicherung und Drittschutz.** Die Polizei ist nach Art. 241 Abs. 4 StPO jederzeit befugt, eine angehaltene (Art. 215 StPO) oder vorläufig festgenommene Person (Art. 217 StPO) ohne Durchsuchungsbefehl am Körper und an den mitgeführten Effekten abzutasten, um sicherzustellen, dass sie keine Waffen oder gefährlichen Gegenstände auf sich trägt ([BGer 6B_899/2017 vom 14. Februar 2018](https://entscheidsuche.ch/docs/CH_BGer/CH_BGer_006_6B-899-2017_2018-02-14.html) E. 2.2).

**Rz. 9** **Schranken der Sicherheitsdurchsuchung.** Die Sicherheitsdurchsuchung dient ausschliesslich dem Schutz von Personen und nicht der gezielten Beweisausforschung. Eine vollständige Entkleidung (Leibesvisitation) bedarf konkreter Anhaltspunkte für Selbst- oder Fremdgefährdung ([LU Kantonsgericht 2N 22 37 vom 21. Juni 2022](https://entscheidsuche.ch/docs/LU_Gerichte/LU_KG_001_2N-22-37_2022-06-21.html)).
