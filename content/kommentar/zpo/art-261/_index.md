...
revisions:
  - date: 2026-08-13
    ...
    model: "claude-opus-5"
    mcp_verified: true
    note: "Belegapparat saniert (Belegquote 35 % → 100 %, Urteil A); BGE 138 III 378 stand für das Beweismass der Glaubhaftmachung, betrifft aber die aufschiebende Wirkung nach Art. 315 Abs. 5 ZPO; nicht tragende Belege entfernt, die dogmatischen Aussagen bleiben"
  - date: 2026-08-13
    by: "Claude Code"
    model: "claude-opus-5"
    mcp_verified: false
...
*   **Reiner Vermögensschaden** gilt nach ständiger Rechtsprechung des Bundesgerichts grundsätzlich als **wiedergutzumachen** (durch Schadenersatz,).
...
**5** **Herabgesetzter Beweismassstab**: Im Gegensatz zum Hauptverfahren, in dem der strikte Beweis verlangt wird, genügt im Massnahmeverfahren die **Glaubhaftmachung** (Art. 261 Abs. 1 ZPO). Die Tatsachen müssen nicht zweifelsfrei bewiesen werden; es genügt, wenn sie dem Gericht als **überwiegend wahrscheinlich** erscheinen. Das Verfahren wird im summarischen Verfahren geführt (Art. 248 lit. d ZPO), weshalb in der Regel nur präsente Beweismittel (Urkunden) zugelassen sind.
