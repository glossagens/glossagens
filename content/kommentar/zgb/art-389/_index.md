...
Der Grundsatz lautet: *«Soviel staatliche Fürsorge wie nötig, so wenig staatlicher Eingriff wie möglich»* (BBl 2006 7017 Ziff. 1.3.4). [BGE 140 III 49](https://mcp.opencaselaw.ch/entscheid/bge_BGE_140_III_49), E. 4.3.1 formuliert dies als Leitentscheid.
...
Massgebend ist, ob die Hilfe **aktuell nicht ausreicht** oder **von vornherein als ungenügend erscheint**. Die KESB muss prüfen, ob die private Hilfe **qualitativ und quantitativ** ausreichend ist.([BGE 140 III 49](https://mcp.opencaselaw.ch/entscheid/bge_BGE_140_III_49), E. 4.3.1; BGer 5A_702/2013, E. 4; OGVE 2016/17 Nr. 66 — Obwalden)

**Genügendes Helfernetz**: Wenn die betroffene Person über ein funktionierendes Netz aus Vertrauenspersonen, Arzt und Arbeitgeber verfügt, ist eine Beistandschaft nicht subsidiär ([OGVE 2016/17 Nr. 66](https://mcp.opencaselaw.ch/entscheid/ow_gerichte_OGVE-2016-17-66), Obwalden).
...
([OGVE 2016/17 Nr. 20](https://mcp.opencaselaw.ch/entscheid/ow_gerichte_OGVE-2016-17-20), Obwalden: Validierter Vorsorgeauftrag ersetzt Beistandschaft)
...
Die **Wahl der mildesten ausreichenden Massnahme** ist zwingend ([BGer 5A_795/2014](https://mcp.opencaselaw.ch/entscheid/bger_5A_795_2014), E. 3.2; Zusammenhang mit Art. 391 Abs. 1 ZGB: Bedürfnisse der betroffenen Person stehen im Zentrum).
...
([OGVE 2018/19 Nr. 62](https://mcp.opencaselaw.ch/entscheid/ow_gerichte_OGVE-2018-19-62), Obwalden: Begleitbeistandschaft statt Vertretungsbeistandschaft bei 19-jähriger Frau mit Lernbehinderung)

### IV. Kasuistik

#### 1. Romance-Scam und finanzielle Gefährdung

[BGer 5A_502/2025](https://mcp.opencaselaw.ch/entscheid/bger_5A_502_2025): Ein 1935 geborener Beschwerdeführer geriet durch Romance-Scam-Aktivitäten in finanzielle Gefährdung. Die Bank meldete den Verdacht an die APEA. Das Bundesgericht bestätigt die Vertretungsbeistandschaft mit Handlungsfähigkeitsbeschränkung (curatelle de représentation et de gestion). Das Subsidiaritätsprinzip ist gewahrt: Der Beschwerdeführer konnte die angebotene Hilfe nicht annehmen und gefährdete sich selbst finanziell.

#### 2. Psychiatrische Expertise als Eingriff

[BGer 5A_1109/2025](https://mcp.opencaselaw.ch/entscheid/bger_5A_1109_2025): Die Anordnung einer psychiatrischen Expertise (Art. 446 Abs. 2 ZGB) stellt einen Eingriff in die persönliche Freiheit (Art. 10 Abs. 2 BV) dar, der selbst dem Verhältnismässigkeitsprinzip unterliegt (Art. 36 Abs. 3 BV, Art. 389 Abs. 2 ZGB). Die Expertise muss erforderlich sein, um den Schutzbedarf zu ermitteln. Das Bundesgericht hob die Vorinstanzentscheidung auf und wies die Sache zurück.

#### 3. Helfernetz ersetzt Beistandschaft

[OGVE 2016/17 Nr. 66](https://mcp.opencaselaw.ch/entscheid/ow_gerichte_OGVE-2016-17-66) (Obwalden): Eine Person mit genügend grossem Helfernetz (Vertrauensperson, Psychiater, Hausarzt, Arbeitgeber) benötigt keine Beistandschaft, selbst bei einem Schwächezustand.

#### 4. Vorsorgeauftrag ersetzt Massnahme

[OGVE 2016/17 Nr. 20](https://mcp.opencaselaw.ch/entscheid/ow_gerichte_OGVE-2016-17-20) (Obwalden): Sind die Voraussetzungen für die Validierung eines Vorsorgeauftrags erfüllt und ist dieser umfassend ausgestaltet, kann auf weitergehende Massnahmen verzichtet werden.
...
- **Art. 8 EMRK**: Die Subsidiarität staatlicher Eingriffe bei Schutzmassnahmen korrespondiert mit dem EGMR-Grundsatz, dass familiäre Massnahmen ein letztes Mittel (ultima ratio) sein müssen ([EGMR, Strand Lobben u.a. c. Norvège](https://mcp.opencaselaw.ch/entscheid/ecthr_grand_chamber_37283_13)).

### VI. Materialien

**Botschaft KESR** (BBl 2006 7001, Ziff. 2.2.1 und 1.3.4):
Die Subsidiarität bedeutet, dass behördliche Massnahmen nur dann anzuordnen sind, wenn die Betreuung auf andere Weise nicht angemessen sichergestellt ist. Statt standardisierter Massnahmen sollen nur so viel staatliche Betreuung angeordnet werden, wie wirklich nötig ist. Die Verhältnismässigkeit erfordert, dass jede Massnahme erforderlich und geeignet ist.
