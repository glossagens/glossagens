...
date: 2026-05-16
lastmod: "2026-08-31"
description: "Kommentar zu Art. 219 StGB: Verletzung der Fürsorge- oder Erziehungspflicht — Garantenstellung, Gefährdung der Entwicklung Minderjähriger, unechte Konkurrenz, Handlungseinheit und Verjährung."
...
revisions:
  - date: 2026-08-31
    ...
    model: "glm-5.1"
    mcp_verified: true
    note: "Vollständiger Neuaufbau mit Sachverhaltsanreicherung: 3 verifizierte BGE-Leitentscheide via entscheidsuche.ch; BGE 125 IV 64 (Schulverantwortliche bei sexuellem Missbrauch), BGE 126 IV 136 (unechte Konkurrenz mit sexuellen Delikten), BGE 149 IV 240 (Handlungseinheit, Verjährung, wiederholte Misshandlung); LU OG 21 09 113 (Besuchsrechtsverhinderung) auf entscheidsuche.ch verifiziert; Gesetzeswortlaut → Wortlaut korrigiert; alle Links durch entscheidsuche.ch ersetzt"
  - date: 2026-08-13
    by: "Hermes Agent"
    model: "glm-5.1"
    mcp_verified: true
...
- **Gesetz** (z.B. elterliche Sorge nach [Art. 296 ff. ZGB](https://www.fedlex.admin.ch/eli/cc/27/311_321_329/de#art_296));
...
Als Garanten kommen namentlich in Betracht: die Eltern (natürliche und Adoptiveltern), der Vormund, Lehrpersonen, Schulleitungen, Heimleiter sowie sonstige Verantwortliche von Einrichtungen für Minderjährige ([BGE 125 IV 64](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_006_BGE-125-IV-64_1999-02-02.html) E. 1a).
...
**5** Der Tatbestand setzt **in der Regel** voraus, dass der Täter wiederholt handelt oder seine Pflicht nachhaltig verletzt, so dass die Entwicklung des Minderjährigen gefährdet ist. Erst diese Dauerhaftigkeit oder Wiederholung begründet die tatbestandliche Entwicklungsgefährdung ([BGE 149 IV 240](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_006_BGE-149-IV-240_2023.html) E. 2.2).
...
**9** **Abs. 2 (fahrlässige Begehung)**: Bei fahrlässiger Tatbegehung ist die Strafe Geldstrafe. Der Richter hat bei fahrlässiger Tat die **Möglichkeit**, aber nicht die Pflicht, auf Geldstrafe statt auf Freiheitsstrafe zu erkennen. Massgebendes Kriterium ist die **Schwere des Verschuldens** ([BGE 125 IV 64](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_006_BGE-125-IV-64_1999-02-02.html) E. 2).
...
**11** Erfüllt dasselbe Verhalten sowohl den Tatbestand des Art. 219 StGB als auch einen schwereren Tatbestand (z.B. sexuelle Nötigung nach Art. 189 StGB, Vergewaltigung nach Art. 190 StGB), so liegt **unechte Konkurrenz** vor: Art. 219 StGB wird durch die schwerere Norm **konsumiert** ([BGE 126 IV 136](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_006_BGE-126-IV-136_2000-04-10.html) E. 1).
...
**13** Wenn die Fahrlässigkeit des Täters nicht nur die Gesundheit einer anvertrauten minderjährigen Person beeinträchtigt, sondern überdies die körperliche oder seelische Entwicklung **anderer** Minderjähriger gefährdet, für die er verantwortlich ist, ist Art. 219 StGB **unabhängig** von einer allfälligen Anwendbarkeit von Art. 125 StGB anwendbar ([BGE 125 IV 64](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_006_BGE-125-IV-64_1999-02-02.html) E. 1e).

---

## V. Verjährung und Handlungseinheit

**14** Die verschiedenen Misshandlungen, die nach Art. 219 StGB strafbar sind, bilden eine **tatbestandliche Handlungseinheit** i.S.v. Art. 98 lit. b StGB. Die Verjährung beginnt an dem Tag, an dem die letzte tatbestandsmässige Handlung begangen wurde ([BGE 149 IV 240](https://entscheidsuche.ch/docs/CH_BGE/CH_BGE_006_BGE-149-IV-240_2023.html) E. 3).

---

## VI. Abgrenzung: Besuchsrechtsverhinderung

**15** Verhindert der Inhaber der elterlichen Sorge die Ausübung des Besuchsrechts des anderen Elternteils, so macht er sich **nicht** der Verletzung der Fürsorge- oder Erziehungspflicht schuldig. Die blosse Verhinderung des Besuchsrechts fällt nicht unter Art. 219 StGB ([Gericht LU 21 09 113](https://entscheidsuche.ch/docs/LU_Gerichte/LU_OG_001_21-09-113_2010-04-22.html); Leitsatz).
